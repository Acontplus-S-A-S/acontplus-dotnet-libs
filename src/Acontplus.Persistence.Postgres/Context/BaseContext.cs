...
public class PostgresModelBuilderOptions
{
...
{
    private readonly PostgresModelBuilderOptions _postgresOptions = new();
    ...
    protected virtual void ApplyPostgresConfigurations(ModelBuilder builder)
    {
        if (_postgresOptions.EnableDecimalConversion)
        {
        ...
        if (_postgresOptions.EnableNonUnicodeStrings)
        {
            foreach (var property in builder.Model.GetEntityTypes()
                         .SelectMany(t => t.GetProperties())
